({
    ...
    doInit : function(component, event, helper) {
        ...
        console.log('@@@Language>>>>>>>'+$A.get("$Locale.langLocale"));
        component.set("v.language",$A.get("$Locale.langLocale"));
        ...
        CountryAction.setCallback(this, function(response) {            
            var state = response.getState();
            if (state === "SUCCESS") {               
                var countryResponse = response.getReturnValue();  
                console.log('@@Country>>>>>'+JSON.stringify(countryResponse));
                component.set("v.country", countryResponse);
            }            
        });
