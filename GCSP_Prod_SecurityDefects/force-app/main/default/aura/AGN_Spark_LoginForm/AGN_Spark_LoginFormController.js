({
    ...
    closeModal:function(component,event,helper){ 
       	helper.clsModal(component, event);
    },
    forgotPassword:function(component, event, helpler){
      /*  var urlEvent = $A.get("e.force:navigateToURL");
    	...
    	urlEvent.fire();*/
         window.location.href =  '/Spark/s/forgot-password/' ;
    },
    
    displayRegisterForm :function(component,event,helper){ 
       	console.log("Entering the hepler of login register");
    },
