            ...
            if(!wellFormatted){
                ...
                action.setCallback(this, function(response){
                    ...
                    if (state === "SUCCESS") {
                        ...
                        //practEvent.fire();   
                        setTimeout(function(){ practEvent.fire();  }, 10000);
                        //AWS
                        ...
                        //GTM
                        var compEvent = component.getEvent("sharePractionsersDetailsGTM");
                        compEvent.setParams({ "param": newpract });
                        compEvent.fire();
                        //GTM
        ...
        action.setCallback(this, function(response) {
            if(component.isValid()) {
                if(response.getState() === 'SUCCESS') {
                    ...
                    this.showTosteMessage(component, '', 'success',$A.get("$Label.c.AGN_ICL_PractitionerSuccessMsg"), 'dismissible');
