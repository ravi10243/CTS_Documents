({
    init : function(component, event, helper) {
        ...
        action.setCallback(this, function(actionResult) {
            console.log('@@user details ::: ',actionResult.getReturnValue());
    ...
    logout : function(component, event, helper) {
        ...
        var userDetals = component.get("v.userDetail");
        var baseUrl;
        ...
        window.location.replace( baseUrl + "/AGN_CustomerPortalLogout_v2"+'?country='+userDetals.Country_Code__c+'&language='+userDetals.LocaleSidKey);
    } 
})