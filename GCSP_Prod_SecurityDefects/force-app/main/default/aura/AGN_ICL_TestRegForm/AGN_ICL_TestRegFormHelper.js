({
            ...
            cmps.forEach( function (cmp){
                if (!$A.util.isEmpty(cmp.get("v.fieldRegex")) && jQuery.trim(cmp.get("v.fieldValue")) != ''){
                    if(!cmp.get("v.isFormatValid")){
                        ...
                        console.log('dfdfd'+formatfields);
            ...
            cmps.forEach( function (cmp){
                ...
                if(cmp.get("v.sobjectName") === 'Account'){
                    ...
                    else if(cmp.get("v.TypeofAccount") ==='Clinic Admin')
                    {
                        ...
                        console.log('Account Admin>>' +cmp.get("v.fieldName")+ ' && '+cmp.get("v.fieldValue")); 
                    ...
                    console.log("Locator"+cmp.get("v.fieldName"));
                    component.set(derivedField,cmp.get("v.fieldValue"));
                }
            });
            component.set("v.spinner",true);
            if(component.get("v.showClinicImage")){
    ...
    updatellisting :function(component,event)
    {
        ...
        console.log('Clinic_Admin_details '+JSON.stringify(component.get("v.Clinic_Admin_details")));
        ...
        action.setParams({
            ...
            'AccFirstName' : component.get("v.Clinic_Admin_details").FirstName,
            'AccLastName' : component.get("v.Clinic_Admin_details").LastName,
            'AccSalutation' : component.get("v.Clinic_Admin_details").Salutation,
            'AccId' : component.get("v.Clinic_Admin_details").Id,
        }); 
    ...
    uploadHelper: function(component, event,parentid) {
        ...
        if(file==undefined || (component.get('v.imageurl') ==  component.get('v.imageurlTemp'))){
            this.updatellisting(component,event);
        } 
        else
        {
    ...
    upload: function(component, file, fileContents,parentid) {
        ...
        actions.setCallback(this, function(response) {
            if(component.isValid()) {
                console.log('AWS image upload', response.getState() );
                if(response.getState() === 'SUCCESS') {
