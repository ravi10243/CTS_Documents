({
    ...
    onCheckBoxChange : function(component, event, helper){
        ...
        checkboxVal.forEach(function(val){
            if(finalSelectedValue){
            	finalSelectedValue = finalSelectedValue + val+";";
            } else {
                finalSelectedValue = val+";";
            }
        });
        component.find("hiddenPickList").set("v.value",finalSelectedValue);
