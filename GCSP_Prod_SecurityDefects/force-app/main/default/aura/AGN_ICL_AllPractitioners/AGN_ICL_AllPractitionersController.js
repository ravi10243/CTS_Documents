({
     doInit: function(component,event,helper) {
        //alert('inside Allpracitioners doinit');
         ...
         //component.set("v.url","https://s3-eu-west-1.amazonaws.com/allergan-icl/a875E0000005kipQAA-Lighthouse.jpg");
    ...
    deletePractitioner: function(component,event,helper){                 
        if(confirm($A.get('$Label.c.AGN_ICL_HCP_ConfirmDelete')))
    ...
    addPractitioner : function(component,event,helper){
        ...
        //component.set("v.twoLayerLayout",true);
    },
