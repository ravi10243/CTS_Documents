({
        getShipToDocumnetList: function(component, event, helper) {
        //console.log("[FileUpload].[=====helper1=====]");
        var action = component.get("c.getShipToAttachments");
        action.setParams({
            ...
            if(component.isValid() && response !== null && response.getState() == 'SUCCESS'){
                ...
                if ($A.util.isArray(attList)){
                    ...
                    var requiredInsertDocCount=0;
                     var requiredToDownLoad = 0; // for downLoadButton
                    ...
                    attList.forEach( function (att){
                        if(requiredTotalDocsCount == requiredInsertDocCount){
                            var missdoc = component.getEvent("isManadteDocmant");
  ...
  // this is new function upload file upto 5.7 mb
               ...
               if (startPosition < endPosition) {
                ...
                if(startPosition=endPosition){
                    ...
                    if(component.get("v.isSingleAttachment")){
                        ...
                        component.set("v.showSpinner", false);                        
                        this.getShipToDocumnetList(component,event);
                    }
